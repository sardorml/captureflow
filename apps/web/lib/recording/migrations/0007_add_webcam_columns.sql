-- Companion webcam stream for a recording. Recordings now upload TWO parallel
...
ALTER TABLE recordings ADD COLUMN webcam_storage_key TEXT;
ALTER TABLE recordings ADD COLUMN webcam_upload_id   TEXT;
ALTER TABLE recordings ADD COLUMN webcam_size_bytes  INTEGER NOT NULL DEFAULT 0;
ALTER TABLE recordings ADD COLUMN webcam_state       TEXT NOT NULL DEFAULT 'none'
