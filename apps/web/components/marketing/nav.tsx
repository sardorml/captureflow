  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* One right-hand cluster. GitHub and Discord live in the drawer and
            the footer rather than competing with the single CTA here.
            Desktop/mobile split is CSS-gated (not JS breakpoints) so the server
            render matches the viewport — no mobile→desktop flip after
            hydration. */}
