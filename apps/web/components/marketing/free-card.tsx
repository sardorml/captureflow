...
// Server badge uses the lucide icon, not <Icon>: the icon font is a ligature subset
// and a missing name renders as raw literal text.
export function FreeCard() {
  ...
  return (
    <div className="rounded-xl bg-white p-12 ring-1 ring-black/10">
      {/* min-h-8 matches the Managed card's badge-row height to keep both cards aligned. */}
